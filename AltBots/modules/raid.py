...
async def raid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            if uid in ALTRON:
                await e.reply("𝐀𝐁𝐄𝐘 𝐄𝐒𝐄 𝐑𝐍𝐃𝐈 𝐊 𝐁𝐀𝐂𝐂𝐇𝐎 𝐏𝐑 𝐓𝐈𝐌𝐄 𝐖𝐀𝐒𝐓𝐄 𝐍 𝐊𝐑𝐓𝐄 𝐇𝐔𝐌 😂🖕")
            elif uid == OWNER_ID:
                await e.reply("𝐀𝐁𝐄𝐘 𝐌𝐀𝐃𝐀𝐑𝐂𝐇𝐎𝐃 𝐀𝐔𝐊𝐀𝐓 𝐌𝐄 𝐑𝐄𝐇😤🖕!! 𝐘𝐄 𝐁𝐀𝐀𝐏 𝐇𝐀𝐈 𝐓𝐄𝐑𝐀 𝐁𝐇𝐈 𝐀𝐔𝐑 𝐌𝐄𝐑𝐀 𝐁𝐇𝐈🤣🌚")
            elif uid in SUDO_USERS:
                await e.reply("𝐀𝐁𝐄 𝐄𝐒𝐊𝐈 𝐁𝐇𝐈 𝐀𝐔𝐊𝐀𝐓 𝐓𝐄𝐑𝐈 𝐉𝐈𝐓𝐍𝐈 𝐇𝐈 𝐇𝐀𝐈😂 𝐄𝐒𝐊𝐄 𝐏𝐀𝐒 𝐕 𝐒𝐔𝐃𝐎 𝐇𝐀𝐈 𝐁𝐎𝐓 𝐊𝐀 🥲")
            else:
    ...
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            if user_id in ALTRON:
                ...
                await e.reply("»𝐂𝐎𝐌𝐌𝐀𝐍𝐃 𝐀𝐂𝐂𝐄𝐏𝐓𝐄𝐃!✅ 𝐀𝐁 𝐘𝐄 𝐉𝐁 𝐁𝐇𝐈 𝐌𝐒𝐆 𝐊𝐀𝐑𝐄𝐆𝐀 𝐌𝐀𝐈 𝐄𝐒𝐊𝐈 𝐌𝐀𝐀 𝐂𝐇𝐎𝐃𝐔𝐍𝐆𝐀🌚")
        except NameError:
...
async def drraid(e):
    if e.sender_id in SUDO_USERS:
        ...
        try:
            ...
            await e.reply("𝐂𝐎𝐌𝐌𝐀𝐍𝐃 𝐀𝐂𝐂𝐄𝐏𝐓𝐄𝐃!✅ 𝐁𝐇𝐊! 𝐀𝐁 𝐘𝐄 𝐉𝐁 𝐁𝐇𝐈 𝐌𝐒𝐆 𝐊𝐀𝐑𝐄𝐆𝐀 𝐌𝐀𝐈 𝐄𝐒𝐊𝐈 𝐌𝐀𝐀 𝐍𝐇𝐈 𝐂𝐇𝐎𝐃𝐔𝐍𝐆𝐀😔👍")
        except NameError:
