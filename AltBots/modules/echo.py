    ...
    if event.sender_id in SUDO_USERS:
        if event.reply_to_msg_id:
            ...
            if user_id in ALTRON:
                ...
                await event.reply("𝐀𝐁𝐄𝐘 𝐌𝐀𝐃𝐀𝐑𝐂𝐇𝐎𝐃 𝐀𝐔𝐊𝐀𝐓 𝐌𝐄 𝐑𝐄𝐇😤🖕!! 𝐘𝐄 𝐁𝐀𝐀𝐏 𝐇𝐀𝐈 𝐓𝐄𝐑𝐀 𝐁𝐇𝐈 𝐀𝐔𝐑 𝐌𝐄𝐑𝐀 𝐁𝐇𝐈🤣🌚")
            elif user_id in SUDO_USERS:
                await event.reply("𝐀𝐁𝐄 𝐄𝐒𝐊𝐈 𝐁𝐇𝐈 𝐀𝐔𝐊𝐀𝐓 𝐓𝐄𝐑𝐈 𝐉𝐈𝐓𝐍𝐈 𝐇𝐈 𝐇𝐀𝐈😂 𝐄𝐒𝐊𝐄 𝐏𝐀𝐒 𝐕 𝐒𝐔𝐃𝐎 𝐇𝐀𝐈 𝐁𝐎𝐓 𝐊𝐀 🥲")
            else:
                try:
